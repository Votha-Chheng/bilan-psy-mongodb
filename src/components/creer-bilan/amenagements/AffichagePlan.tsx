...
const AffichagePlan = () => {
  ...
  const checkIfCategoryIsInamenagementForPatient = (amenagementsForPatient: AmenagementItemDTO[]|null, categoryToCheck: string): boolean=> {
  ...
  const getAmenagementsForPatientByCategory = (category: string, amenagementsForPatient: AmenagementItemDTO[]): AmenagementItemDTO[]=> {
